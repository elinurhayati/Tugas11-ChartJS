		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				{	// Data total case
					...
					backgroundColor: 'rgba(52, 86, 139, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(21, 34, 55)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				},
				{	// Data new case
					label: 'New Case',
					data: <?php echo json_encode($kasus_baru); ?>, // Memanggil variabel yang akan dijadikan isi chart
					backgroundColor: 'rgba(249, 103, 20, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(124, 48, 3)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				}, 
				{	// Data total death
					label: 'Total Death',
					data: <?php echo json_encode($total_kematian); ?>, // Memanggil variabel yang akan dijadikan isi chart
					backgroundColor: 'rgba(250, 224, 60, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(75, 65, 2)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				},
				{	// Data new death
					label: 'New Death',
					data: <?php echo json_encode($kematian_baru); ?>, // Memanggil variabel yang akan dijadikan isi chart
					backgroundColor: 'rgba(0, 161, 112, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(0, 77, 54)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				},
				{	// Data total recovery
					label: 'Total Recovery',
					data: <?php echo json_encode($total_sembuh); ?>, // Memanggil variabel yang akan dijadikan isi chart
					backgroundColor: 'rgba(205, 33, 42, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(132, 21, 26)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				},
				{	// Data new recovery
					label: 'New Recovery',
					data: <?php echo json_encode($sembuh_baru); ?>, // Memanggil variabel yang akan dijadikan isi chart
					backgroundColor: 'rgba(181, 101, 167, 0.2)', // Mengatur warna background line chart
					borderColor: 'rgba(69, 33, 62)', //Mengatur warna border line chart
					borderWidth: 2, //Mengatur lebar border line chart
				}
